...
LocalWeb 是一个通过 skill 机制外挂到本地 agent CLI 的可视化与上下文交互层。
...
LocalWeb Web = 可视化投影、结构化阅读面、可选上下文输入面
```
...
主题：手绘漫画感的本地飞船控制台
主色：#ffd43b
背景：#31566e / #2e4f67 / #274159
描边：#07111b，2px-4px 硬线
辅助色：#ffb454 橙、#35d8ff 青、#fff8d6 奶白
圆角：4px-6px，小圆角
...
`references/visual-style.md` 放蓝灰科幻底、高对比黄色和漫画描边的视觉规范。
